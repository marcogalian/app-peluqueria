package com.marcog.peluqueria.citas.infrastructure.web;

import com.marcog.peluqueria.citas.application.GestionarAgenda;
import com.marcog.peluqueria.citas.domain.Cita;
import com.marcog.peluqueria.citas.infrastructure.web.dto.CitaAgendaDto;
import com.marcog.peluqueria.citas.infrastructure.web.dto.ResumenDiaDto;
import com.marcog.peluqueria.citas.infrastructure.web.dto.CitaResumenDto;
...
import com.marcog.peluqueria.citas.application.GenerarTicketCita;
...
public class CitaController {
    ...
    private final GenerarTicketCita generarTicketCita;
    ...
    public ResponseEntity<List<Cita>> getCitas(
        ...
        return ResponseEntity.ok(gestionarAgenda.getCitas(start, end, peluqueroId));
    }
    ...
    public ResponseEntity<Cita> getCitaById(@PathVariable UUID id) {
        return ResponseEntity.ok(gestionarAgenda.getCitaById(id));
    }
    ...
    public ResponseEntity<Cita> createCita(@RequestBody Cita cita) {
        return ResponseEntity.ok(gestionarAgenda.createCita(cita));
    }
    ...
    public ResponseEntity<Cita> updateCita(@PathVariable UUID id, @RequestBody Cita cita) {
        return ResponseEntity.ok(gestionarAgenda.updateCita(id, cita));
    }
    ...
    public ResponseEntity<Cita> cancelarCita(
        ...
        return ResponseEntity.ok(gestionarAgenda.cancelar(id, motivo));
    }
    ...
    public ResponseEntity<List<CitaAgendaDto>> getCitasAgenda(
        ...
        List<Cita> citas = gestionarAgenda.getCitas(inicio, fin, null);
    ...
    public ResponseEntity<byte[]> descargarTicketPdf(@PathVariable UUID id) {
        try {
            byte[] pdfBytes = generarTicketCita.generarTicket(id);
    ...
    private CitaResumenDto citaToCitaResumenDto(Cita cita) {
        ...
        return CitaResumenDto.builder()
            ...
            .servicioNombre(servicioNombre)
            .estado(cita.getEstado().toString())
            .peluqueroNombre(cita.getPeluquero() != null ? cita.getPeluquero().getNombre() : "")
            .build();
    }
}
