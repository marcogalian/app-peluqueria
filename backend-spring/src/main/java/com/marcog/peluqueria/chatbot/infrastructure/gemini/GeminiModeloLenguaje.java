package com.marcog.peluqueria.chatbot.infrastructure.gemini;
...
public class GeminiModeloLenguaje implements ModeloLenguaje {
    ...
    public GeminiModeloLenguaje(@Qualifier("geminiRestTemplate") RestTemplate restTemplate, ObjectMapper mapper) {
