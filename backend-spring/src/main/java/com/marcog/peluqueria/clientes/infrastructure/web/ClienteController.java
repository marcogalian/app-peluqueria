package com.marcog.peluqueria.clientes.infrastructure.web;
...
import com.marcog.peluqueria.clientes.application.ActualizarCliente;
import com.marcog.peluqueria.clientes.application.ConsultarClientes;
...
public class ClienteController {
    ...
    public ResponseEntity<List<Cliente>> getAllClientes(
        ...
        if (nombre != null || esVip != null) {
            return ResponseEntity.ok(consultarClientes.buscarClientes(nombre, esVip, archivado));
        }
        return ResponseEntity.ok(consultarClientes.getAllClientes(archivado));
    }
    ...
    public ResponseEntity<HistorialClinicoDTO> getHistorialClinico(@PathVariable UUID id) {
        return ResponseEntity.ok(consultarClientes.getHistorialClinico(id));
    }
    ...
    public ResponseEntity<Cliente> registrar(@RequestBody Cliente cliente) {
        Cliente clienteCreado = registrarCliente.ejecutar(cliente);
    ...
    public ResponseEntity<Cliente> actualizar(@PathVariable UUID id, @RequestBody Cliente cliente) {
        return ResponseEntity.ok(actualizarCliente.actualizarCliente(id, cliente));
    }
    ...
    public ResponseEntity<Cliente> archivar(@PathVariable UUID id) {
        return ResponseEntity.ok(actualizarCliente.actualizarArchivado(id, true));
    }
    ...
    public ResponseEntity<Cliente> reactivar(@PathVariable UUID id) {
        return ResponseEntity.ok(actualizarCliente.actualizarArchivado(id, false));
    }
    ...
    public ResponseEntity<Cliente> actualizarConsentimiento(
        ...
        return ResponseEntity.ok(actualizarCliente.actualizarConsentimiento(id, valor));
    }
}
